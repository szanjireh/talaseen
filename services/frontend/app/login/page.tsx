          ...
          <div className="hidden md:flex justify-center">
            <div className="w-full max-w-lg rounded-2xl overflow-hidden shadow-2xl">
              <img
                ...
                onError={(e) => { (e.currentTarget as HTMLImageElement).src = 'https://images.unsplash.com/photo-1605100804763-247f67b3557e?w=1200&h=800&fit=crop'; }}
              />
            </div>
          </div>
            ...
            <div className="w-full max-w-md bg-white dark:bg-[#0b1220] rounded-2xl shadow-xl p-8">
              ...
              <div className="space-y-4">
                ...
                >
                  <span className="w-6 h-6 flex items-center justify-center">
                    <svg viewBox="0 0 24 24" className="w-5 h-5">
                      <path fill="#EA4335" d="M12 11.5v3.1h4.4c-.2 1.2-.9 2.3-1.9 3.1l3 2.3c1.8-1.6 2.9-4 2.9-6.9 0-.7-.1-1.4-.2-2.1H12z" />
                      <path fill="#34A853" d="M6.5 14c-.5-1-.8-2.1-.8-3.2s.3-2.2.8-3.2L3.5 5.3C2.2 7.1 1.5 9.5 1.5 12c0 2.5.7 4.9 2 6.7l3-2.7z" />
                      <path fill="#4A90E2" d="M12 4.5c1 0 1.9.3 2.7.9l2-2C16.8 2.1 14.6 1 12 1 7.8 1 3.9 3.4 2.4 7.6l3 2.7C7.1 8 9.4 6.5 12 6.5z" />
                      <path fill="#FBBC05" d="M4.5 18.7c1.5 2.9 4.9 4.8 8.5 4.8 3.2 0 6-1.4 7.9-3.6l-3-2.3c-1 1-2.4 1.7-4 1.7-2.9 0-5.3-1.9-6.1-4.6l-3.3 1.9z" />
                    </svg>
                  </span>
                ...
                <div className="pt-4 text-center">
                  <a href="/" className="text-sm text-orange-600 hover:underline">بازگشت به صفحه اصلی</a>
                </div>
              </div>
            </div>
          </div>
