      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <section className="mb-12 bg-white p-8 rounded-lg border border-amber-100">
          ...
          <p className="text-gray-700 leading-relaxed">
            طلافروشی زنجیره به حفاظت از حریم خصوصی و اطلاعات شخصی شما متعهد است. این سند جامع شرح می‌دهد که چگونه 
            اطلاعات شما جمع‌آوری، استفاده، محافظت و مدیریت می‌شود. ما در تمام فعالیات خود از قوانین و مقررات 
            جمهوری اسلامی ایران و استانداردهای بین‌المللی حفاظت از داده‌ها پیروی می‌کنیم.
          </p>
        </section>
        ...
        <section className="space-y-8 mb-12">
          ...
          <div className="bg-white p-8 rounded-lg border-l-4 border-amber-500">
            ...
            <ul className="space-y-2 text-gray-700">
              <li className="flex gap-3">
                ...
                <span><strong>اطلاعات شناسایی:</strong> نام، شماره تماس، آدرس و اطلاعات تماسی</span>
              </li>
              <li className="flex gap-3">
                <span className="text-amber-600">•</span>
                <span><strong>اطلاعات معاملات:</strong> سابقه خرید، محصولات خریداری شده و قیمت‌ها</span>
              </li>
              <li className="flex gap-3">
                <span className="text-amber-600">•</span>
                <span><strong>اطلاعات مالی:</strong> روش‌های پرداخت و صورت‌حساب‌ها (برای مقاصد قانونی)</span>
              </li>
              <li className="flex gap-3">
                <span className="text-amber-600">•</span>
                <span><strong>اطلاعات فنی:</strong> درخواست‌های شما، IP و اطلاعات مرورگر</span>
              </li>
            </ul>
          </div>
          ...
          <div className="bg-gradient-to-r from-amber-50 to-amber-100/50 p-8 rounded-lg border-l-4 border-amber-700">
            <h3 className="text-2xl font-bold text-amber-900 mb-4">۴. انطباق با مقررات تجارت طلا در ایران</h3>
            <p className="text-gray-700 leading-relaxed mb-4">
            ...
            <div className="space-y-4 text-gray-700">
              <div>
                ...
                <p>
                  ما به عنوان یک فروشگاه طلا و جواهر از نظارت و مقررات سازمان‌های دولتی ایران پیروی می‌کنیم و 
                  تمام معاملات را با شفافیت کامل انجام می‌دهیم.
                </p>
              </div>
              ...
              <div>
                ...
                <p>
                  تمام فروش‌های ما از لحاظ مالیاتی گزارش‌دهی می‌شود و با قوانین سازمان مالیات منطبق است. 
                  ما از سیستم‌های حسابداری معتبر استفاده می‌کنیم.
                </p>
              </div>
              ...
              <div>
                ...
                <p>
                  هر محصول طلا با اطلاعات دقیق عیار، وزن و شناسه‌نامه فروخته می‌شود. این اطلاعات برای مدت 
                  معین نگهداری می‌شود.
                </p>
              </div>
              ...
              <div>
                ...
                <p>
                  تمام محصولات با گواهی‌های رسمی و اعتبارنامه‌های بین‌المللی تحویل داده می‌شوند که مطابق 
                  استاندارد‌های ایران است.
                </p>
              </div>
              ...
              <div>
                ...
                <p>
                  ما از ممنوعیت‌های قانونی درباره معاملات طلا اطلاع دارم و از تمام موارد ممنوعه پرهیز می‌کنیم. 
                  اطلاعات شما تنها برای مقاصد قانونی استفاده می‌شود.
                </p>
              </div>
            </div>
          </div>
          ...
          {/* 6. Contact */}
          <div className="bg-white p-8 rounded-lg border-l-4 border-amber-500">
            <h3 className="text-2xl font-bold text-amber-900 mb-4">۶. تماس برای مسائل حفاظت از اطلاعات</h3>
            <p className="text-gray-700 leading-relaxed mb-4">
            ...
            <div className="bg-amber-50 p-6 rounded border border-amber-200">
              ...
              <p className="text-gray-700"><strong className="text-amber-900">آدرس:</strong> آذربایجان غربی، خوی، چارس، طلافروشی زنجیره</p>
            </div>
          </div>
        </section>
