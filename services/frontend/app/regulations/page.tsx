      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <section className="mb-12 bg-white p-8 rounded-lg border border-amber-100">
          ...
          <p className="text-gray-700 leading-relaxed">
            با استفاده از وب‌سایت و خدمات طلافروشی زنجیره، شما تمامی قوانین و شرایط زیر را می‌پذیرید. 
            لطفاً این متن را با دقت مطالعه کنید. در صورت عدم موافقت با هر بخش، از استفاده از سرویس‌های ما خودداری کنید.
          </p>
        </section>
        ...
        <section className="space-y-8 mb-12">
          ...
          <div className="bg-white p-8 rounded-lg border-l-4 border-amber-500">
            ...
            <div className="space-y-4 text-gray-700">
              ...
              <div>
                ...
                <p>
                  شما حق دارید محصول دریافتی را به دقت بررسی کنید. در صورت عدم تطابق با توضیحات، 
                  از حق برگشت استفاده کنید.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white p-8 rounded-lg border-l-4 border-amber-500">
            ...
            <div className="space-y-4 text-gray-700">
              <div>
                ...
                <p>
                  هر سفارش پس از پرداخت باید توسط تیم مدیریت تأیید شود. در صورت عدم تأیید 
                  (مثلاً تموجود نبودن کالا)، مبلغ به صورت کامل برگردانده خواهد شد.
                </p>
              </div>
              ...
              <div>
                ...
                <p>
                  معمولاً سفارشات در مدت ۲۴ تا ۴۸ ساعت تأیید و برای ارسال آماده می‌شوند. 
                  در روزهای تعطیل ممکن است تأخیر بیفتد.
                </p>
              </div>
              ...
              <div>
                ...
                <p>
                  پس از تأیید سفارش، ما از طریق تلفن یا پیام شما را مطلع می‌کنیم.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white p-8 rounded-lg border-l-4 border-amber-500">
            ...
            <div className="space-y-4 text-gray-700">
              <div>
                ...
                <p>
                  ما روش‌های متعددی برای پرداخت قبول می‌کنیم: درگاه بانکی، انتقال مستقیم، 
                  و پرداخت در محل تحویل.
                </p>
              </div>
              ...
              <div>
                ...
                <p>
                  قیمت‌های طلا بر اساس نرخ روز بازار تعیین می‌شوند. قیمت نهایی پس از تأیید 
                  سفارش ثابت می‌شود.
                </p>
              </div>
              ...
              <div>
                ...
                <p>
                  برای هر خرید صورت‌حساب رسمی صادر می‌شود. صورت‌حساب‌ها برای مقاصد مالیاتی 
                  و حسابداری نگهداری می‌شوند.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white p-8 rounded-lg border-l-4 border-amber-500">
            ...
            <div className="space-y-4 text-gray-700">
              <div>
                ...
                <p>
                  ارسال به دو صورت انجام می‌شود: تحویل مستقیم در محل فروشگاه یا ارسال از طریق 
                  پیک و پست معتبر.
                </p>
              </div>
              ...
              <div>
                ...
                <p>
                  هزینه ارسال در شهر خوی رایگان است. برای سایر نقاط، هزینه به صورت جداگانه محاسبه می‌شود.
                </p>
              </div>
              ...
              <div>
                ...
                <p>
                  معمولاً تحویل در مدت ۳ تا ۵ روز کاری انجام می‌شود. اقلام خاص ممکن است زمان بیشتری نیاز داشته باشند.
                </p>
              </div>
              ...
              <div>
                ...
                <p>
                  تمام محصولات در بسته‌های ایمن و حفاظت‌شده ارسال می‌شوند. شما مسئول 
                  بررسی محتویات در لحظه تحویل هستید.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-r from-amber-50 to-amber-100/50 p-8 rounded-lg border-l-4 border-amber-700">
            ...
            <div className="space-y-4 text-gray-700">
              ...
              <div>
                ...
                <p>
                  بعد از بررسی محصول برگشتی، مبلغ در مدت ۵ تا ۷ روز کاری برگردانده می‌شود.
                </p>
              </div>
          ...
          <div className="bg-white p-8 rounded-lg border-l-4 border-amber-500">
            ...
            <div className="space-y-4 text-gray-700">
              <div>
                ...
                <p>
                  ما گارانتی می‌دهیم که تمام محصولات اصل و با عیار اعلام‌شده هستند. 
                  در صورت عدم صحت، تعویض یا بازپرداخت کامل انجام می‌شود.
                </p>
              </div>
              ...
              <div>
                ...
                <p>
                  ما خدمات اصلاح، تعمیر و تغییرات جزیی را برای محصولات ارائه می‌دهیم.
                </p>
              </div>
          ...
          <div className="bg-white p-8 rounded-lg border-l-4 border-amber-500">
            ...
            <div className="space-y-4 text-gray-700">
              <p className="mb-4">
                طبق قوانین جمهوری اسلامی ایران، موارد زیر ممنوع هستند:
              </p>
          ...
          <div className="bg-white p-8 rounded-lg border-l-4 border-amber-500">
            ...
            <div className="space-y-4 text-gray-700">
              <div>
                ...
                <p>
                  تمام فعالیات ما با قانون تجارت و مقررات سازمان‌های دولتی ایران منطبق است.
                </p>
              </div>
              ...
              <div>
                ...
                <p>
                  ما مسئول گزارش‌دهی تمام معاملات به سازمان مالیات ایران هستیم.
                </p>
              </div>
              ...
              <div>
                ...
                <p>
                  تمام سندها، رسیدها و مستندات برای حداقل ۷ سال نگهداری می‌شود.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white p-8 rounded-lg border-l-4 border-amber-500">
            ...
            <p className="text-gray-700 leading-relaxed mb-6">
              برای هرگونه سوال یا شکایت درباره قوانین و شرایط، لطفاً از طریق موارد زیر با ما تماس بگیرید:
            </p>
            <div className="bg-amber-50 p-6 rounded border border-amber-200 space-y-3">
              ...
              <p className="text-gray-700">
                <strong className="text-amber-900">📍 آدرس:</strong> آذربایجان غربی، خوی، چارس، طلافروشی زنجیره
              </p>
              <p className="text-gray-700">
                <strong className="text-amber-900">⏰ ساعات کاری:</strong> شنبه تا پنج‌شنبه، ۹ صبح تا ۸ شب
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-gradient-to-r from-amber-900 to-amber-800 text-white rounded-lg p-12 text-center">
          ...
          <a href="/contact" className="inline-block px-8 py-3 bg-white text-amber-900 font-bold rounded-full hover:bg-amber-50 transition-colors">
            تماس با پشتیبانی
          </a>
        </section>
      </div>
