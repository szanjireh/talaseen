  ...
  return (
    <div className="container mx-auto px-4 py-12">
      ...
      <p className="text-gray-700 mb-2">
        <strong className="text-amber-900">نام مالک:</strong> حجت زنجیره
      </p>
      <p className="text-gray-700 mb-2">
      ...
      <section className="mt-8 pt-8 border-t">
        ...
        <div className="flex gap-4 flex-wrap">
          <a
            href="#"
            className="flex items-center gap-3 px-5 py-3 bg-gradient-to-r from-amber-50 to-amber-100 border border-amber-200 rounded-lg text-amber-900 hover:shadow-lg hover:border-amber-400 transition-all"
          >
